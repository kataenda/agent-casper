...
/**
 * WalletWidget — self-contained CSPR.click wallet component.
 * Bundles ClickProvider + WalletButton together so this whole module
 * can be loaded with next/dynamic ssr:false (styled-components is browser-only).
 */
...
const clickOptions = {
  ...
  contentMode: CONTENT_MODE.POPUP,   // POPUP tidak butuh app registration di cspr.build
